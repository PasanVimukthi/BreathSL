package com.example.vimuk.breathsrilanka.helper;
...
public class InputValidation {
    ...
    public boolean IsInputEditTextMatches(EditText textInputEditText, EditText textInputEditText2, TextInputLayout textInputLayout, String message){
